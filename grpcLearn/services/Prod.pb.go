...
func (x *ProdRequestName) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdRequestName) ProtoMessage() {}

func (x *ProdRequestName) ProtoReflect() protoreflect.Message {
	mi := &file_Prod_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdRequestName.ProtoReflect.Descriptor instead.
func (*ProdRequestName) Descriptor() ([]byte, []int) {
	return file_Prod_proto_rawDescGZIP(), []int{2}
}

func (x *ProdRequestName) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ProdResponseName) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdResponseName) ProtoMessage() {}

func (x *ProdResponseName) ProtoReflect() protoreflect.Message {
	mi := &file_Prod_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdResponseName.ProtoReflect.Descriptor instead.
func (*ProdResponseName) Descriptor() ([]byte, []int) {
	return file_Prod_proto_rawDescGZIP(), []int{3}
}

func (x *ProdResponseName) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x22, 0x25, 0x0a,
	0x0f, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x26, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x92, 0x01, 0x0a,
	...
	0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x0b, 0x47,
	0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2e, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4e, 0x61, 0x6d,
...
var file_Prod_proto_goTypes = []interface{}{
	...
	(*ProdRequestName)(nil),  // 2: services.ProdRequestName
	(*ProdResponseName)(nil), // 3: services.ProdResponseName
}
var file_Prod_proto_depIdxs = []int32{
	0, // 0: services.ProdService.GetProdStock:input_type -> services.ProdRequest
	2, // 1: services.ProdService.GetProdName:input_type -> services.ProdRequestName
	1, // 2: services.ProdService.GetProdStock:output_type -> services.ProdResponse
	3, // 3: services.ProdService.GetProdName:output_type -> services.ProdResponseName
...
type ProdServiceClient interface {
	...
	GetProdName(ctx context.Context, in *ProdRequestName, opts ...grpc.CallOption) (*ProdResponseName, error)
}
...
func (c *prodServiceClient) GetProdName(ctx context.Context, in *ProdRequestName, opts ...grpc.CallOption) (*ProdResponseName, error) {
	out := new(ProdResponseName)
...
type ProdServiceServer interface {
	...
	GetProdName(context.Context, *ProdRequestName) (*ProdResponseName, error)
}
...
func (*UnimplementedProdServiceServer) GetProdName(context.Context, *ProdRequestName) (*ProdResponseName, error) {
...
func _ProdService_GetProdName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProdServiceServer).GetProdName(ctx, req.(*ProdRequestName))
	}
	return interceptor(ctx, in, info, handler)
}
